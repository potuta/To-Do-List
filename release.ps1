...
$appName = "To-Do List App" # 👈 Replace with your application project name.
$projDir = "C:\Users\cyy\Desktop\coding\c#\To-Do List Application\To-Do List App" # 👈 Replace with your project directory (where .csproj resides).
